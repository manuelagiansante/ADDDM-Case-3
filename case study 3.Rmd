...
#### Exogenous Construct Reliability
...
The CR values are high enogh, without signaling redundancy.
...
#### Mediators Construct Reliability
...
They are high without being redundant.
`allora io cr non lo faccio perchè lei non l ha fatto e io non mi voglio sbattare ad accedere i valori giusti`
...
construct. Discriminant validity is demonstrated when the shared variance within a construct (AVE) exceeds the shared variance between the
constructs. T
