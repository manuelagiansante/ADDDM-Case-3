...
PA1 and variable 15 are grouped together in the correlation matrix already which is encouraging, they are about brand assortment. We will investigate this later on. We will keep these two variables under watch, but for now these two variables make sense to be loading on the factors they are loading on.
...
**prova modelli con meno, vedi im15 e im19**
