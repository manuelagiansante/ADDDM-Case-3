...
In construct3 we defined the total effects:

| Col1                         | Col2 |
|------------------------------|------|
| Assortment to C_REP          |      |
| French lifestyle to C_REP    |      |
| Shopping Experience to C_REP |      |
| Organisation to C_REP        |      |
| Luxury to C_REP              |      |
| Coolness to C_REP            |      |
| Food to C_REP                |      |
| Professionalism to C_REP     |      |
...
parameterestimates(fit3, boot.ci.type = "bca.simple", standardized = TRUE) |>  kable()
```
