...
We observe the estimates of the regression belonging to the eight client
perception factors, we square the coefficients and look at their
magnitudes. Also, we must take note that none of these coefficients are
significant within the structural model. The only significant ones are
the mediators.

```{r}
# create table with estimates values
estimates<-data.frame("name"=c("assor","fr","shp","org","lux","cool","food","prof"),"c_cr"=c(-0.017,-0.132,0.154,-0.034,0.100,0.029,-0.037,-0.161), "c_rep"=c(-0.019,-0.034,0.041,0.009,0.063,-0.014, 0.04,-0.035))
estimates$c_cr2=(estimates$c_cr)^2
estimates$c_rep2=(estimates$c_rep)^2
```

For Co-creation Intention the ranking is the following:

1.  Professionalism: This could be interpreted as professionalism
    encourages the client/Respondent to the survey to engage into more
    of these initiatives and possible workshops organised by the
    Galeries.

2.  Shopping Experience: The client has a
...
For Re-purchase intention the ranking is:
